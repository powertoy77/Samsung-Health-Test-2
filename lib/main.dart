...
class _SamsungHealthHomePageState extends State<SamsungHealthHomePage> {
  ...
  final List<Map<String, String>> _motivationalQuotes = [
    ...
    {"number": "51", "quote": "운동은 당신의 의사결정 능력을 향상시킨다."},
    {"number": "52", "quote": "작은 습관이 인생을 바꾼다."},
    {"number": "53", "quote": "운동은 당신의 에너지 레벨을 높인다."},
    {"number": "54", "quote": "건강한 몸은 성공의 기반이다."},
    {"number": "55", "quote": "운동은 당신의 창의적 사고를 자극한다."},
    {"number": "56", "quote": "매일 조금씩 나아지면, 놀라운 변화가 온다."},
    {"number": "57", "quote": "운동은 당신의 자신감을 키운다."},
    {"number": "58", "quote": "건강은 당신이 가진 가장 중요한 자산이다."},
    {"number": "59", "quote": "운동은 당신의 인내력을 기른다."},
    {"number": "60", "quote": "오늘 운동하지 않으면, 내일 더 어려워진다."},
    {"number": "61", "quote": "운동은 당신의 기억력을 강화한다."},
    {"number": "62", "quote": "작은 목표부터 시작하라. 큰 목표는 작은 목표들의 합이다."},
    {"number": "63", "quote": "운동은 당신의 활력을 되찾아준다."},
    {"number": "64", "quote": "건강한 정신은 건강한 몸에서 나온다."},
    {"number": "65", "quote": "운동은 당신의 문제 해결 능력을 향상시킨다."},
    {"number": "66", "quote": "매일의 노력이 미래의 성공을 만든다."},
    {"number": "67", "quote": "운동은 당신의 스트레스 저항력을 높인다."},
    {"number": "68", "quote": "건강은 당신이 가진 가장 큰 자산이다."},
    {"number": "69", "quote": "운동은 당신의 긍정적 사고를 촉진한다."},
    {"number": "70", "quote": "오늘의 투자가 내일의 보상이 된다."},
    {"number": "71", "quote": "운동은 당신의 판단력을 향상시킨다."},
    {"number": "72", "quote": "작은 변화가 큰 차이를 만든다."},
    {"number": "73", "quote": "운동은 당신의 생산성을 높인다."},
    {"number": "74", "quote": "건강한 생활은 최고의 투자다."},
    {"number": "75", "quote": "운동은 당신의 감정 조절 능력을 향상시킨다."},
    {"number": "76", "quote": "매일의 노력이 성공의 기반이 된다."},
    {"number": "77", "quote": "운동은 당신의 면역 체계를 강화한다."},
    {"number": "78", "quote": "건강은 부와 명예보다 소중하다."},
    {"number": "79", "quote": "운동은 당신의 학습 능력을 향상시킨다."},
    {"number": "80", "quote": "오늘의 선택이 내일의 결과를 결정한다."},
    {"number": "81", "quote": "운동은 당신의 의사결정 능력을 향상시킨다."},
    {"number": "82", "quote": "작은 습관이 인생을 바꾼다."},
    {"number": "83", "quote": "운동은 당신의 에너지 레벨을 높인다."},
    {"number": "84", "quote": "건강한 몸은 성공의 기반이다."},
    {"number": "85", "quote": "운동은 당신의 창의적 사고를 자극한다."},
    {"number": "86", "quote": "매일 조금씩 나아지면, 놀라운 변화가 온다."},
    {"number": "87", "quote": "운동은 당신의 자신감을 키운다."},
    {"number": "88", "quote": "건강은 당신이 가진 가장 중요한 자산이다."},
    {"number": "89", "quote": "운동은 당신의 인내력을 기른다."},
    {"number": "90", "quote": "오늘 운동하지 않으면, 내일 더 어려워진다."},
    {"number": "91", "quote": "운동은 당신의 기억력을 강화한다."},
    {"number": "92", "quote": "작은 목표부터 시작하라. 큰 목표는 작은 목표들의 합이다."},
    {"number": "93", "quote": "운동은 당신의 활력을 되찾아준다."},
    {"number": "94", "quote": "건강한 정신은 건강한 몸에서 나온다."},
    {"number": "95", "quote": "운동은 당신의 문제 해결 능력을 향상시킨다."},
    {"number": "96", "quote": "매일의 노력이 미래의 성공을 만든다."},
    {"number": "97", "quote": "운동은 당신의 스트레스 저항력을 높인다."},
    {"number": "98", "quote": "건강은 당신이 가진 가장 큰 자산이다."},
    {"number": "99", "quote": "운동은 당신의 긍정적 사고를 촉진한다."},
    {"number": "100", "quote": "오늘의 투자가 내일의 보상이 된다."},
  ];
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('빙고판 확인하기 기능은 다음에 구현됩니다!'),
