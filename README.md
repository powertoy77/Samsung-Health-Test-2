...
이 프로젝트는 삼성 헬스 앱의 메인 화면을 Flutter로 구현한 것입니다. 실제 삼성 헬스 앱과 동일한 디자인과 레이아웃을 제공하며, **Daily Activity Detail Page**와 **Sleep Detail Page** 기능이 포함되어 있습니다.
...
├── lib/
│   └── main.dart              # 메인 앱 파일 (Daily Activity & Sleep Detail Pages 포함)
